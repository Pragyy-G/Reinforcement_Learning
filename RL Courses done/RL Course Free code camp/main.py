...
if __name__ == '__main__':
    ...
    agent = Agent(gamma=0.99, epsilon = 1.0, alpha = 0.000255, input_dims = (180,160,4),
                  n_actions=3, mem_size = 4000, batch_size =32)
    if load_checkpoint:
        agent.load_models()
    scores =[]
    numGames=200
